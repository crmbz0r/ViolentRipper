...
**Enable ***Watch Mode** to automatically* capture every single file that gets loaded on the page while you navigate around. Perfect for single page applications and sites that load content dynamically.**
