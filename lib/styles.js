...
(function () {
  ...
  ViolentRipper.getStyles = function () {
    return `
      ...
      .ViolentRipper-chip.active-archive { background: #2e1a2a; border-color: #ff4a9a; color: #ff88cc; }
      .ViolentRipper-chip.active-audio  { background: #1a2e2a; border-color: #4affaa; color: #88ffcc; }
      .ViolentRipper-chip.active-video  { background: #2a2a1a; border-color: #ffaa4a; color: #ffcc88; }
      .ViolentRipper-chip.ViolentRipper-enhanced-toggle {
        background: #1a1a2e; border-color: #ffaa00; color: #ffaa00; margin-left: auto;
      }
      .ViolentRipper-chip.ViolentRipper-enhanced-toggle.enhanced-active {
        background: #3a2a1a; border-color: #ffaa00; color: #ffaa00;
      }
      ...
      .active-archive .dot { background: #ff88cc; }
      .active-audio .dot { background: #88ffcc; }
      .active-video .dot { background: #ffcc88; }
      .ViolentRipper-enhanced-chips {
      ...
      .ViolentRipper-stat.s-archive span { color: #ff88cc; }
      .ViolentRipper-stat.s-audio span { color: #88ffcc; }
      .ViolentRipper-stat.s-video span { color: #ffcc88; }
      #ViolentRipper-log {
      ...
      #ViolentRipper-log .ok-archive { color: #ff88cc; }
      #ViolentRipper-log .ok-audio  { color: #88ffcc; }
      #ViolentRipper-log .ok-video  { color: #ffcc88; }
